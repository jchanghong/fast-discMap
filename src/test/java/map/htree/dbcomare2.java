 ...
 *
 *
 *    Created on  16-12-22 下午1:28 by jiang
...
public class dbcomare2 {
    ...
    public void compare_mapdb() throws Exception {
        for (int j = 0; j < 1; j++) {
            for (int i = 0; i < 1000; i++) {
                person actual = (person) map1.get("ddddd" + i);
    ...
    public void compare_my() throws Exception {
        for (int j = 0; j < 1; j++) {
            for (int i = 0; i < 1000; i++) {
                person actual = (person) mapmy.get("ddddd" + i);
                assertEquals(i, actual.id);
            }
        }
    }
...
//        for (int i = 0; i < 1000; i++) {
//            person.id = i;
//            mapmy.put("ddddd" + i, person);
//            map1.put("ddddd" + i, person);
//        }
//        db2.close();
    }
...
//        for (int i = 0; i < 5; i++) {
//            assertEquals(i, map1.get("ddddd" + i));
//        }
    }
...
//        for (int i = 0; i < 5; i++) {
//            assertEquals(i, mapmy.get("ddddd" + i));
//        }
    }
